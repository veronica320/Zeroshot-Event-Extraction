...
hypothesis_dict['BE-BORN'] = ["someone's birth", "someone's childbirth"]
hypothesis_dict['MARRY'] = ["someone's marriage", "someone's wedding", "wedding", "marrying"]
hypothesis_dict['DIVORCE'] = ["someone's divorce", "divorcing"]
hypothesis_dict['INJURE'] = ["someone's injury", "hurting", "wounding", "injuring"]
hypothesis_dict['DIE'] = ["someone's death", "killing", "suicide", "dying"]
hypothesis_dict['TRANSPORT'] = ["someone or something moving from one place to another", "someone's journey", "someone's trip", "visiting", "coming", "going", "arriving"]
hypothesis_dict['TRANSFER-OWNERSHIP'] = ["a transfer of ownership", "buying", "selling", "seizing", "acquiring"]
hypothesis_dict['TRANSFER-MONEY'] = ["a transfer of money", "paying", "donation", "loan"]
...
hypothesis_dict['PHONE-WRITE'] = ["a telephone or written communication with someone", "calling", "writing"]
hypothesis_dict['START-POSITION'] = ["someone being hired", "an appointment", "appointing", "hiring"]
hypothesis_dict['END-POSITION'] = ["someone no longer working on a position", "resignation", "retirement"]
