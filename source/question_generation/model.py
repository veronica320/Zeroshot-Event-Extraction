...
# predictor is loaded from the archive
from dataset_reader import QuestionGenerationDatasetReader
from predictor import QuestionGenerationPredictor
from util import ALL_SPECIAL_TOKENS
...
@Model.register('question_generation')
class _QuestionGenerationModel(Model):
    def __init__(self,
                 vocab: Vocabulary,
                 model_name: str,
